...
function ModifyModSettings()
{
	...
	$subActions = array(
		...
		'custom_menu' => 'ModifyCustomTopMenu',
...
// Top menu admin section.			
function ModifyCustomTopMenu($return_config = false)
{
	global $txt, $scripturl, $context, $settings, $sc, $modSettings;
	...
	$context['post_url'] = $scripturl . '?action=admin;area=modsettings;save;sa=custom_menu';
	$context['settings_title'] = $txt['custom_menu_title'];
	...
	if (isset($_GET['save']))
	{
		...
		redirectexit('action=admin;area=modsettings;sa=custom_menu');
